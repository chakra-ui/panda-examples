...
The shadcn design system lives in `examples/monorepo/packages/ds`. The `standalone-app` and `panda-app` examples consume it as the published `@chakra-ui/shadcn-panda` package.
